...
<nav class="navbar navbar-expand-lg space_content navbar-light">
    ...
    <div class="main_content space_content mt-md-5 fadeIn slow">
        <div class="row container_fliudsu">
            <!-- Inicio de apartado categorías  -->
            <div class="col-md-3 text-category">
                <?php 
                    $query= "SELECT id_categoria,categoria,(SELECT COUNT(producto) FROM t_producto p WHERE p.id_categoria =c.id_categoria) AS numero_productos from t_categorias c";
                    $mysqli->real_query($query);
                    $query  = $mysqli-> store_result();
                    while($row = $query->fetch_assoc()) { ?> 
                        <div class="row mt-md-2">
                            <button class="btn btn-block" onclick="selectCategory('<?php echo $row['id_categoria'];?>')">
                                <div class="row">
                                    <div class="col-md-6 text-left"><?php echo $row['categoria']; ?></div>
                                    <div class="col-md-6 text-right"><?php echo $row['numero_productos'];?></div>
                                </div>
                            </button>
                        </div>
                    <?php }?>    
            ...
            <!-- Fin de apartado categorías -->

            <!-- Inicio de apartado de artículos -->
            <div class="col-md container-article">
                ...
                <div class="row">
                    ...
                    <div class="col-6 text-right">
                        Popular Nuevo En oferta ...
                    </div>
                </div>

                <div class="row">
                    <!-- productos -->
                    <div id="container_products" class="col">
                        <?php
                        ...
                        $query= "SELECT id_producto,producto,preven,imagen from t_producto WHERE producto LIKE '%".$value."%'";
