...
<body>
    ...
    <nav class="navbar navbar-expand-lg space_content navbar-light">
        ...
        <div class="collapse navbar-collapse ml-5" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="history_buy.php">Historial de compras</a>
                </li>
            </ul>
            <form action="search.php" class="form-inline my-2 my-lg-0 mr-5" method="get">
                <li class="nav-item">
                    <input type="text" name="value" id="input_search_nav" class="nav-link" placeholder="jaja" onkeyup="searchProduct(event)" >
                </li>
                <li class="nav-item">
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <?php 
                            if(  isset ($_SESSION['id_user'])) { 
                                $id_user = $_SESSION['id_user'];
                                $query = "SELECT cliente FROM t_cliente WHERE id_cliente=$id_user";
                                $result_login =  $mysqli->query($query);
                                $info_user = $result_login->fetch_assoc(); ?>
                                <a class="nav-link" href="logout.php"><?php echo $info_user['cliente'];?></a>
                        <?php }else  { ?>
    ...
    INNER JOIN t_codpos on t_codpos.id_codpos=t_cliente.id_codpos WHERE id_cliente=$id_user");
    $query  = $mysqli->store_result();
    ...
    <div class="container">
           <form method="post" action="profile_user.php">
               ...
               <input type="text" value="<?php echo ($name); ?>" class="form-control"><br>
               <label for="">Nombre de contacto:</label><br>
               <input type="text" value="<?php echo ($contacto); ?>" class="form-control"><br>
               <label for="">Telefono 1:</label><br>
               <input type="text" value="<?php echo ($telefono1); ?>" class="form-control"><br>
               <label for="">Correo 1:</label><br>
               <input type="text" value="<?php echo ($correo1); ?>" class="form-control"><br>
               <label for="">Telefono 2:</label><br>
               <input type="text" value="<?php echo ($telefono2); ?>" class="form-control"><br>
               <label for="">Correo 2:</label><br>
               <input type="text" value="<?php echo ($correo2); ?>" class="form-control"><br>
               <label >Elige nuevo estado:</label>
                ...
                <?php
                    ...
                    <option value="<?php echo $valores['id_estado'];?>" 
                    <?php
                            if ($valores['id_estado'] == $estado) {
                            echo 'selected';
                                                  }
                                                ?>    
            >
                <?php echo $valores['estado'];?>    
            </option>
        <?php } ?>
</select>
<br>
               <label for="">Estado:</label><br>
               <input type="text" value="<?php echo ($estado); ?>" class="form-control"><br>
               <label for="">Municipio:</label><br>
               <input type="text" value="<?php echo ($municipio); ?>" class="form-control"><br>
               <label for="">Colonia:</label><br>
               <input type="text" value="<?php echo ($colonia); ?>" class="form-control"><br>
               <label for="">Código Postal:</label><br>
               <input type="text" value="<?php echo ($codpos); ?>" class="form-control" ><br>
               <label for="">Calle:</label><br>
               <input type="text" value="<?php echo ($calle); ?>" class="form-control" ><br>
               <label for="">Número exterior:</label><br>
               <input type="text" value="<?php echo ($noext); ?>" class="form-control" ><br>
               <label for="">Número interior:</label><br>
               <input type="text" value="<?php echo ($noint); ?>" class="form-control" ><br>
